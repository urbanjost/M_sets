...
interface unique;    module procedure unique_i,    unique_c;     end interface unique
interface union;     module procedure union_i,     union_c;      end interface union
interface intersect; module procedure intersect_i, intersect_c;  end interface intersect
interface setdiff;   module procedure setdiff_i,   setdiff_c;    end interface setdiff
interface ismember;  module procedure ismember_i,  ismember_c;   end interface ismember
interface setxor;    module procedure setxor_i,    setxor_c;     end interface setxor
interface issorted;  module procedure issorted_i,  issorted_c;   end interface issorted
...
!!##LICENSE
!!    CC0-1.0
function unique_i(A, setOrder) result(result)
...
!!##LICENSE
!!    CC0-1.0
function union_i(A, B, setOrder) result(result)
...
!!##LICENSE
!!    CC0-1.0
function intersect_i(A, B, setOrder) result(result)
...
!!##LICENSE
!!    CC0-1.0
function setdiff_i(A, B, setOrder) result(result)
...
!!##LICENSE
!!    CC0-1.0
function ismember_i(A, B) result(result)
...
!!##LICENSE
!!    CC0-1.0
function setxor_i(A, B, setOrder) result(result)
...
!!##LICENSE
!!    CC0-1.0
function issorted_i(A) result(result)
...
! ident_1="@(#) M_strings lower(3f) Changes a string to lowercase over specified range"
